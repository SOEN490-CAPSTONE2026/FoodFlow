...
import ReceiverAchievements from '../components/ReceiverDashboard/ReceiverAchievements';
...
jest.mock('../components/shared/Leaderboard', () => {
...
jest.mock('../components/shared/PointsDisplay', () => {
