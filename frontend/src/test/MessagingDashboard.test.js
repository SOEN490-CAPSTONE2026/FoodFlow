...
import MessagingDashboard from '../components/MessagingDashboard/MessagingDashboard';
...
jest.mock('../components/MessagingDashboard/ConversationsSidebar', () => ({
  __esModule: true,
  default: ({
    conversations,
    loading,
...
jest.mock('../components/MessagingDashboard/ChatPanel', () => ({
  __esModule: true,
...
jest.mock('../components/MessagingDashboard/NewConversationModal', () => ({
  __esModule: true,
