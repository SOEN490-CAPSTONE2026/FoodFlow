...
jest.mock('../components/ReceiverDashboard/ReceiverLayout', () => {
...
jest.mock('../components/ReceiverDashboard/ReceiverWelcome', () => {
  return function ReceiverWelcome() {
    return <div data-testid="welcome">Welcome Page</div>;
  };
});

jest.mock('../components/ReceiverDashboard/ReceiverBrowse', () => {
  return function ReceiverBrowse() {
    return <div data-testid="browse">Browse Page</div>;
  };
});

jest.mock('../components/ReceiverDashboard/ReceiverMyClaims', () => {
