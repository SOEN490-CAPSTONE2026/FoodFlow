...
import AIDonationForm from '../components/DonorDashboard/AIDonationForm';
...
jest.mock('../components/DonorDashboard/AIImageUpload', () => {
...
jest.mock('../components/DonorDashboard/AIExtractionReview', () => {
