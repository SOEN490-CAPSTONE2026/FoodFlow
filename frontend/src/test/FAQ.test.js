...
describe('FAQ Component', () => {
  ...
  test('renders all FAQ questions from data', () => {
    ...
    expect(
      screen.getByText('How can I use FoodFlow to donate my surplus food?')
    ).toBeInTheDocument();
    expect(
      screen.getByText(
    ...
    expect(
      screen.getByText('Is there any cost to use FoodFlow?')
    ).toBeInTheDocument();
    expect(
      screen.getByText('How does FoodFlow ensure food safety?')
    ).toBeInTheDocument();
  });
