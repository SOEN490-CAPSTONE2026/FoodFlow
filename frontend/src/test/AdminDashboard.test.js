...
jest.mock('../components/AdminDashboard/AdminUsers', () => {
  return function MockAdminUsers() {
    return <div data-testid="admin-users">Admin Users</div>;
  };
});

jest.mock('../components/AdminDashboard/AdminLayout', () => {
