    ...
    <div className="impact-dashboard">
      <div className="dashboard-header">
        <div className="header-content">
          ...
          <p className="subtitle">
            {t(
              'impactDashboard.subtitle',
              'See the environmental and social impact of your donations'
            )}
          </p>
        </div>
      ...
      <div className="metrics-grid">
        ...
        <div className="metric-card primary">
          ...
          <div className="metric-content">
            <h3>{t('impactDashboard.foodWeight', 'Food Weight Saved')}</h3>
      ...
      <div className="impact-message">
        <div className="message-content">
          ...
          <p>
            {t(
              'impactDashboard.donorMessage',
              'Your donations have helped reduce food waste and support your community. Every contribution counts!'
            )}
          </p>
        </div>
      </div>
