          ...
          >
            ...
            <div className="suggest-form-group">
              ...
              <input
                ...
                placeholder={t('suggestBusiness.form.businessNamePlaceholder')}
            ...
            <div className="suggest-form-group">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder={t('suggestBusiness.form.contactEmailPlaceholder')}
            ...
            <div className="suggest-form-group">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder={t('suggestBusiness.form.contactPhonePlaceholder')}
                disabled={submitting}
              />
            </div>
