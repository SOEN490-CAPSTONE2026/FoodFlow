                  ...
                  <div className="form-section row-group">
                    <div className="input-group half-width">
                      ...
                      <span className="input-help-text">
                        Select the storage temperature for food safety
                        verification
                      </span>
                    </div>
                ...
                <div className="form-step-content">
                  ...
                  <div className="form-section">
                    <div className="input-group">
                      ...
                      />
                      <span className="input-help-text">
                        System will auto-calculate expiry date based on food
                        type
                      </span>
                    </div>
                  </div>
                    ...
                    <div className="input-group">
                      ...
                      {formData.calculatedExpiryDate &&
                        formData.fabricationDate && (
                          <span className="input-help-text">
                            Suggested expiry:{' '}
                            {formatDate(formData.calculatedExpiryDate)} (based
                            on food category)
                          </span>
                        )}
                    </div>
