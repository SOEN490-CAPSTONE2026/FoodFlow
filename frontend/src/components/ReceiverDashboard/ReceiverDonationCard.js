...
export default function ReceiverDonationCard({
  ...
  // Show confetti when card is expanded and donation is completed
  useEffect(() => {
    // TEMP: Show for any expanded card to test
    if (expanded) {
  ...
  return (
    <>
      {/* Confetti using Portal - renders outside card to avoid clipping */}
      {showConfetti &&
        createPortal(
          <div className="confetti-container">
            {[...Array(12)].map((_, index) => (
              ...
              >
                <Sparkles size={20} className="confetti-sparkle" />
              </div>
            ))}
          </div>,
          document.body
      ...
      <div
        ref={cardRef}
        className={`receiver-donation-card ${expanded ? 'expanded' : ''}`}
      >
        {recommendation && (
          <div
            ...
            <div className="receiver-donor-info">
              ...
              <span>
                {t('receiverBrowse.donatedBy', {
                  donorName:
                    item.donorName || t('receiverBrowse.localBusiness'),
                })}
              </span>
            </div>
          </div>
                ...
                <div className="receiver-details-section">
                  ...
                  <div className="receiver-detail-item">
                    <span className="receiver-detail-label">
                      ...
                      {item.pickupSlots && item.pickupSlots.length > 1
                        ? 's'
                        : ''}
                    </span>
                    <div className="receiver-detail-value">
