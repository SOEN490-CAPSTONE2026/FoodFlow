    ...
    return (
      <div data-testid="region-selector">
        ...
        <button
          ...
          onClick={() => onChange({ region: 'US', timezone: 'America/New_York' })}
        >
          Change Region
        </button>
      </div>
...
describe('AdminSettings', () => {
  ...
  describe('Section Rendering', () => {
    ...
    it('renders Language & Region section', () => {
      ...
      expect(
        screen.getByText('Set your language, location, and timezone preferences')
      ).toBeInTheDocument();
    });
  ...
  describe('Form Validation', () => {
    ...
    it('validates phone number format', () => {
      ...
      const phoneInput = screen.getByPlaceholderText('Enter your phone number');
      fireEvent.change(phoneInput, { target: { name: 'phoneNumber', value: 'invalid' } });
  ...
  describe('Notification Preferences', () => {
    ...
    it('renders SMS alerts toggle', () => {
      ...
      expect(screen.getByText(/Receive notifications via text message/)).toBeInTheDocument();
    });

    it('toggles email alerts on', () => {
      renderWithContext();
      
      const emailToggle = screen.getByText('Email Alerts')
    ...
    it('toggles SMS alerts on', () => {
      ...
      const smsToggle = screen.getByText('SMS Alerts')
        .closest('.preference-item')
        .querySelector('input[type="checkbox"]');
  ...
  describe('Notification Types Section', () => {
    ...
    it('toggles individual notification on and off', () => {
      ...
      const flaggedDonationsToggle = screen.getByText('Flagged Donations')
    ...
    it('toggles multiple notifications independently', () => {
      ...
      const flaggedToggle = screen.getByText('Flagged Donations')
        .closest('.notification-item')
        .querySelector('input[type="checkbox"]');
      
      const disputeToggle = screen.getByText('New Disputes')
        .closest('.notification-item')
        .querySelector('input[type="checkbox"]');
