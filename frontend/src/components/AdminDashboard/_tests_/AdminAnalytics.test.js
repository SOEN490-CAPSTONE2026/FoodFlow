...
describe("AdminAnalytics", () => {
  ...
  test("renders Analytics heading", async () => {
    ...
    expect(screen.getByRole("heading", { name: /Food Safety Compliance Analytics/i })).toBeInTheDocument();
  });
  ...
  test("displays analytics data when loaded successfully", async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText(/Total donations analyzed:/i)).toBeInTheDocument();
