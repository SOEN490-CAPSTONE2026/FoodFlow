  ...
  return (
    <div className="admin-approval-banner">
      ...
      <div className="admin-approval-content">
        ...
        <p>
          Your email has been verified! Your account is currently awaiting approval from our admin team.
          This process typically takes up to 48 hours. You'll receive an email notification once your account is approved.
        </p>
