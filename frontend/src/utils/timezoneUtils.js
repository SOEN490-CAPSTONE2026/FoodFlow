...
export const getDateSeparatorInTimezone = (timestamp, userTimezone = 'UTC') => {
  ...
  try {
    ...
    const messageDateInUserTz = new Date(messageDate.toLocaleString('en-US', { timeZone: userTimezone }));
 ...
 */
export const areDifferentDaysInTimezone = (timestamp1, timestamp2, userTimezone = 'UTC') => {
  ...
  try {
    ...
    const date1InUserTz = new Date(date1.toLocaleString('en-US', { timeZone: userTimezone }));
    const date2InUserTz = new Date(date2.toLocaleString('en-US', { timeZone: userTimezone }));
