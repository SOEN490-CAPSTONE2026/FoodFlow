import { validatePassword, getPasswordPolicyDescription } from '../passwordValidation';
...
describe('validatePassword', () => {
    ...
    test('should reject password without special character', () => {
        ...
        expect(errors).toContainEqual(expect.stringContaining('Password must contain at least one special character'));
    });
    ...
    test('should return multiple errors for very weak password', () => {
        ...
        expect(errors).toContainEqual(expect.stringContaining('Password must be at least 10 characters'));
        expect(errors).toContainEqual(expect.stringContaining('Password must contain at least one uppercase letter'));
        expect(errors).toContainEqual(expect.stringContaining('Password must contain at least one digit'));
        expect(errors).toContainEqual(expect.stringContaining('Password must contain at least one special character'));
    });
