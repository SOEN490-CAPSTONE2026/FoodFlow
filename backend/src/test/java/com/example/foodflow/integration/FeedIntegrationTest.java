...
class FeedIntegrationTest {
        ...
        void donorPostCreationStillWorks() throws Exception {
                ...
                String postJson = "{"
                                ...
                                + "\"pickupLocation\": {\"address\": \"123 Donor Street, Ottawa, ON\", \"latitude\": 45.4215, \"longitude\": -75.6972},"
        ...
        void newPostAppearsInFeed() throws Exception {
                ...
                String postJson = "{"
                                ...
                                + "\"pickupLocation\": {\"address\": \"456 Donor Street, Ottawa, ON\", \"latitude\": 45.4215, \"longitude\": -75.6972},"
                                + "\"expiryDate\": \"2030-01-01\","
                                + "\"pickupDate\": \"2030-01-01\","
                                + "\"pickupFrom\": \"15:00:00\","
                                + "\"pickupTo\": \"18:00:00\","
