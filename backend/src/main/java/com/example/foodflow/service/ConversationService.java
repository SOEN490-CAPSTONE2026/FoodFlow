    ...
    public ConversationResponse expressInterestInDonation(Long postId, User receiver) {
        ...
        if (alreadyExists) {
            ...
            try {
                ...
                logger.error("Failed to send email interest notification to donor userId={}: {}", donor.getId(),
                        e.getMessage());
            ...
            try {
                ...
                logger.error("Failed to send SMS interest notification to donor userId={}: {}", donor.getId(),
                        e.getMessage());
